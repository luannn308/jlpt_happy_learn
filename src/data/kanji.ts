...
export const kanjiData: KanjiData[] = [
    ...
    },
    {
        ...
        kanji: "判",
        han: "PHÁN",
        components: "Bộ <strong>Đao</strong> (刂).",
    ...
    },
    {
        ...
        kanji: "性",
        han: "TÍNH",
        components: "Bộ <strong>Tâm</strong> (忄) + Chữ <strong>Sinh</strong> (生).",
    ...
    },
    {
        ...
        kanji: "粉",
        han: "PHẤN",
        components: "Bộ <strong>Mễ</strong> (米) + Chữ <strong>Phân</strong> (分).",
    ...
    },
    {
        ...
        kanji: "鉱",
        han: "KHOÁNG",
        components: "Bộ <strong>Kim</strong> (金) + Chữ <strong>Quảng</strong> (広).",
    ...
    },
    {
        ...
        kanji: "講",
        han: "GIẢNG",
        components: "Bộ <strong>Ngôn</strong> (言) + Chữ <strong>Cấu</strong> (冓).",
    ...
    },
    {
        ...
        kanji: "罪",
        han: "TỘI",
        components: "Bộ <strong>Võng</strong> (罒 - lưới) + Chữ <strong>Phi</strong> (非).",
    ...
    },
    {
        ...
        kanji: "略",
        han: "LƯỢC",
        components: "Bộ <strong>Điền</strong> (田) + Chữ <strong>Các</strong> (各).",
    ...
    },
    {
        ...
        kanji: "糖",
        han: "ĐƯỜNG",
        components: "Bộ <strong>Mễ</strong> (米) + Chữ <strong>Đường</strong> (唐).",
    ...
    },
    {
        ...
        kanji: "素",
        han: "TỐ",
        components: "Bộ <strong>Mịch</strong> (糸 - sợi tơ).",
    ...
    },
    {
        ...
        kanji: "険",
        han: "HIỂM",
        components: "Bộ <strong>Phụ</strong> (阝 - vách núi) + Chữ <strong>Kiểm</strong> (佥).",
